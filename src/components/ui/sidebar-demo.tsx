...
import { Sidebar, SidebarBody, SidebarLink } from "@/components/ui/sidebar-mini";
          ...
          <div>
            <SidebarLink
              link={{
                ...
                icon: (
                  <img
                    src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=256&q=80&auto=format&fit=crop"
